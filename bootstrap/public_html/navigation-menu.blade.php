            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                        ...
                        <div class="jetstream-link-logo">
                            <i class="fas fa-microphone-alt"> OKELIST</i>
                        </div>
                    </a>
                </div>
                ...
                <form method="get" action="{{ route('search') }}">
                    <input class="search" type="text" name="search" placeholder="キーワードを入力して検索"　value="@if (isset($search)) {{ $search }} @endif">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <!-- Account Management -->
                <x-jet-responsive-nav-link href="{{ route('home') }}" :active="request()->routeIs('profile.show')">
                    {{ __('Home') }}
                </x-jet-responsive-nav-link>
